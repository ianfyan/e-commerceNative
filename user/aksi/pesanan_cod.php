<?php
    ...
    $sql = "INSERT into tb_pesanan values ('$id_pesanan', '$id_pelanggan', '$nama_pelanggan', '$alamat', '$no_hp', '$total_cart', '$status_pesanan', '', '$tanggal')";
    $result = $conn->prepare($sql);
    $result->execute();
    ...
    $result->execute();
    unset($_SESSION['sesi']);
    header('location: ../store.php?page=pembayaran')
?>