                    ...
                    <div class="wrap-table-shopping-cart bgwhite">
                        <table class="table-shopping-cart">
                            ...
                            <tr class="table-row">
                                ...
                                <td class="column-5"><?= "Rp. ".number_format($data['sub_total'], 2, ',','.') ?></td>
                            </tr>
                            <?php } ?>
                        </table>
                        <?php
                        ...
                        <div class="bo9 p-l-40 p-r-40 p-t-30 m-t-30  col-md-12">
                            ...
                            <div>
                                <center>
                                    <br>
                                    <a href="aksi/cetakstruk.php?id_pesanan=<?php echo $id_pesanan;?>" target="_blank"><button class="btn btn-primary"><i class="fa fa-file"></i>&nbsp Cetak Bukti Transaksi</button></a>
                                    <br><br>
                                </center>
                            </div>
                        </div>
