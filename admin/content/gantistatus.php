                                        ...
                                        <div class="col-md-10" style="padding-right:1px">
                                            <form action="aksi/ganti_status.php" method="post">
                                                <div class="form-group">
                                                    <input type="text" class="form-control Kode " name="id" placeholder="Kode Pesanan" value="<?php echo $data['id_pesanan'] ?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" class="form-control Nama" name="nama" placeholder="Nama Pelanggan" value="<?php echo $data['nama_pelanggan'] ?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" class="form-control Kategori" name="total" placeholder="Total Bayar" value="<?php echo $data['total'] ?>" readonly>
                                                </div>
                                                <div class="form-group">
