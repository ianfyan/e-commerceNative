                ...
                <div class="row">
                        ...
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                    <span><i class="fa fa-gift f-s-40 color-primary"></i></span>
                                </div>
                                <div class="media-body media-text-right">
                                    <p class="m-b-0">Lihat Daftar Promo</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <p class="m-b-0">Lihat Daftar Barang</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <p class="m-b-0">Lihat Daftar Pelanggan</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <p class="m-b-0">Lihat Semua Pesanan</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                    <span><i class="fa fa-folder f-s-40 color-success"></i></span>
                                </div>
                                <div class="media-body media-text-right">
                                    <p class="m-b-0">Laporan</p>
                                </div>
                            </div>
                        </div>
                    </div>
