                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="aksi/edit_rekening.php" method="post">
                                        ...
                                        <div class="form-group">
                                            <select name="nama_bank" id="" class="form-control" required>
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control Nama" placeholder="Atas Nama" name="nama" value="<?= $data['an']?>" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control Nama" placeholder="Nomor Rekening" name="no_rek" value="<?= $data['no_rek']?>" required>
                                        </div>
                                        <center>
