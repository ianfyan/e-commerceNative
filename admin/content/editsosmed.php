                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="aksi/edit_sosmed.php" method="post">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control Nama" placeholder="Atas Nama" name="nama_sosmed" readonly value="<?= $data['nama_sosmed']?>" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control Nama" placeholder="Nama Akun" name="nama_akun" value="<?= $data['nama_akun']?>" required>
                                        </div>
                                        <center>
