                                ...
                                <div class="basic-form">
                                    <form action="aksi/tambah_barang.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <input type="text" class="form-control Nama" placeholder="Nama" name="nama_produk"  required>
                                        </div>
                                        <div class="form-group">
                                            <?php
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control Harga" placeholder="Harga" name="harga" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control Jumlah" placeholder="Jumlah" name="jumlah" required>
                                        </div>
                                        <div class="form-group">
