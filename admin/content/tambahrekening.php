                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="aksi/tambah_rekening.php" method="post">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control Nama" placeholder="Atas Nama" name="nama" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control Nama" placeholder="Nomor Rekening" name="no_rek" required>
                                        </div>
                                        <center>
