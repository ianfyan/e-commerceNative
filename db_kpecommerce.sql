...
(11, 'BR1635477085', 2, 2, 100000),
(12, 'BR1635477085', 11, 1, 67000);

--
-- Triggers `tb_detailpesanan`
--
DELIMITER $$
...
(27, 27, '1635490150IMG_20181005_WA0007_scaled.jpg'),
(28, 28, '1635490237keripik jagung.jpg'),
(29, 29, '1635490306kerajinan-bonggol-jagng-indri.jpg');
...
(1, 'Benih', 'produk/1635486632DSC_3345.JPG'),
(2, 'Snack', 'produk/1635486828keripik jagung.jpg'),
(3, 'Kerajinan', 'produk/163548761110886750_202007051210170362.jpg'),
(4, 'Olahan', 'produk/16354870745-resep-olahan-jagung-manis-bakwan-puding-sampai-asinan-jagung-bakar.jpg'),
(5, 'Lainnya', 'produk/1635488633page.jpg');
...
(13, 'doni', 'doni', 'akn.multimedia@gmail.com', '2000-10-29', 'Karangmenjangan 2/11A', '085648688508', '2da9cd653f63c010b6d6c5a5ad73fe32');
...
('BR', 13, '', '', '', '', 'Belum diproses', 0, '2021-10-29'),
...
('BR1635477085', 13, 'doni', 'Karangmenjangan 2/11A', '085648688508', '167000', 'Belum diproses', 0, '2021-10-29');
...
(2, 1, 'Batik Tulis', 'Batik Tulis asli Madura. Dengan proses pengerjaan yang rapi', 50000, 32),
...
(11, 2, 'Bunga Kulit Jagung', '', 67000, 42),
...
(27, 1, 'Madura 3', '', 40000, 100),
(28, 2, 'Emping Jagung', '', 5000, 100),
(29, 5, 'Lampu Tidur', '', 100000, 100);
...
(1, 'Whatsapp', ' +6285648688506'),
(2, 'Instagram', '@eumkm_jatim'),
(3, 'Facebook', 'eumkm Jatim');
...
--
-- Table structure for table `tmp_detailcart`
--
...
--
-- Dumping data for table `tmp_detailcart`
--
...
(7, 1634648838, 2, 50000, 1, 50000),
(8, 1634648838, 5, 45000, 1, 45000),
(9, 1634886014, 2, 50000, 1, 50000),
(10, 1634886014, 2, 50000, 1, 50000),
(11, 1635477085, 2, 50000, 2, 100000),
(12, 1635477085, 11, 67000, 1, 67000),
(13, 1635490182, 27, 40000, 1, 40000);

-- --------------------------------------------------------

--
-- Table structure for table `tmp_pengiriman`
--
...
--
-- Dumping data for table `tmp_pengiriman`
--
...
(7, 1634648838, '', '', ''),
(8, 1634886014, '', '', ''),
(9, 1635477085, 'doni', 'Karangmenjangan 2/11A', '085648688508'),
(10, 1635477085, 'doni', 'Karangmenjangan 2/11A', '085648688508'),
(11, 1635490182, '', '', '');
...
--
-- Indexes for table `tmp_detailcart`
--
...
--
-- Indexes for table `tmp_pengiriman`
--
...
--
-- AUTO_INCREMENT for table `tmp_detailcart`
--
ALTER TABLE `tmp_detailcart`
  MODIFY `id_detailcart` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `tmp_pengiriman`
--
ALTER TABLE `tmp_pengiriman`
...
--
-- Constraints for table `tmp_detailcart`
--
ALTER TABLE `tmp_detailcart`
